...
add_cells_to_pblock [get_pblocks pblock_slr1] [get_cells -quiet [list core_inst/iface[0].mac[0].tx_reg/pipe_reg[0].reg_inst core_inst/iface[0].mac[0].rx_reg/pipe_reg[1].reg_inst]]
add_cells_to_pblock [get_pblocks pblock_slr1] [get_cells -quiet [list core_inst/iface[1].mac[0].tx_reg/pipe_reg[0].reg_inst core_inst/iface[1].mac[0].rx_reg/pipe_reg[1].reg_inst]]
...
add_cells_to_pblock [get_pblocks pblock_slr2] [get_cells -quiet [list qsfp2_cmac_inst qsfp2_cmac_pad_inst]]
