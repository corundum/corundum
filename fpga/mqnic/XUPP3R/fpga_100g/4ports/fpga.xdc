...
# GTY Bank 122 OSC 1
set_property -dict {LOC AR36 } [get_ports qsfp1_mgt_refclk_0_p]
set_property -dict {LOC AR37 } [get_ports qsfp1_mgt_refclk_0_n]
...
#------------------------------------------------------
set_property -dict {LOC AA45 } [get_ports qsfp2_rx1_p]
set_property -dict {LOC AA46 } [get_ports qsfp2_rx1_n]
set_property -dict {LOC AA40 } [get_ports qsfp2_tx1_p]
set_property -dict {LOC AA41 } [get_ports qsfp2_tx1_n]
set_property -dict {LOC Y43 } [get_ports qsfp2_rx2_p]
set_property -dict {LOC Y44 } [get_ports qsfp2_rx2_n]
set_property -dict {LOC Y38 } [get_ports qsfp2_tx2_p]
set_property -dict {LOC Y39 } [get_ports qsfp2_tx2_n]
set_property -dict {LOC W45 } [get_ports qsfp2_rx3_p]
set_property -dict {LOC W46 } [get_ports qsfp2_rx3_n]
set_property -dict {LOC W40 } [get_ports qsfp2_tx3_p]
set_property -dict {LOC W41 } [get_ports qsfp2_tx3_n]
set_property -dict {LOC V43 } [get_ports qsfp2_rx4_p]
set_property -dict {LOC V44 } [get_ports qsfp2_rx4_n]
set_property -dict {LOC V38 } [get_ports qsfp2_tx4_p]
set_property -dict {LOC V39 } [get_ports qsfp2_tx4_n]

# GTY Bank 125 OSC 2
set_property -dict {LOC AC36 } [get_ports qsfp2_mgt_refclk_0_p] ;# MGTREFCLK0P_230 from U14.4 via U43.15
set_property -dict {LOC AC37 } [get_ports qsfp2_mgt_refclk_0_n] ;# MGTREFCLK0N_230 from U14.5 via U43.16
# GTY Bank 125 Prog Clk B2 0
# set_property -dict {LOC AA36 } [get_ports qsfp2_mgt_refclk_1_p] ;# MGTREFCLK1P_230 from U12.18
# set_property -dict {LOC AA37 } [get_ports qsfp2_mgt_refclk_1_n] ;# MGTREFCLK1N_230 from U12.17
...
set_property -dict {LOC BF20 IOSTANDARD LVCMOS18 } [get_ports qsfp2_i2c_scl]
set_property -dict {LOC BA20 IOSTANDARD LVCMOS18 } [get_ports qsfp2_i2c_sda]
...
#------------------------------------------------------
set_property -dict {LOC N45 } [get_ports qsfp3_rx1_p]
set_property -dict {LOC N46 } [get_ports qsfp3_rx1_n]
set_property -dict {LOC N40 } [get_ports qsfp3_tx1_p]
set_property -dict {LOC N41 } [get_ports qsfp3_tx1_n]
set_property -dict {LOC M43 } [get_ports qsfp3_rx2_p]
set_property -dict {LOC M44 } [get_ports qsfp3_rx2_n]
set_property -dict {LOC M38 } [get_ports qsfp3_tx2_p]
set_property -dict {LOC M39 } [get_ports qsfp3_tx2_n]
set_property -dict {LOC L45 } [get_ports qsfp3_rx3_p]
set_property -dict {LOC L46 } [get_ports qsfp3_rx3_n]
set_property -dict {LOC L40 } [get_ports qsfp3_tx3_p]
set_property -dict {LOC L41 } [get_ports qsfp3_tx3_n]
set_property -dict {LOC K43 } [get_ports qsfp3_rx4_p]
set_property -dict {LOC K44 } [get_ports qsfp3_rx4_n]
set_property -dict {LOC J40 } [get_ports qsfp3_tx4_p]
set_property -dict {LOC J41 } [get_ports qsfp3_tx4_n]

# GTY Bank 127 OSC 3
set_property -dict {LOC R36 } [get_ports qsfp3_mgt_refclk_0_p] ;# MGTREFCLK0P_230 from U14.4 via U43.15
set_property -dict {LOC R37 } [get_ports qsfp3_mgt_refclk_0_n] ;# MGTREFCLK0N_230 from U14.5 via U43.16
# GTY Bank 127 Prog Clk B3
#set_property -dict {LOC N36 } [get_ports qsfp3_mgt_refclk_1_p] ;# MGTREFCLK1P_230 from U12.18
#set_property -dict {LOC N37 } [get_ports qsfp3_mgt_refclk_1_n] ;# MGTREFCLK1N_230 from U12.17
...
set_property -dict {LOC BC22 IOSTANDARD LVCMOS18 } [get_ports qsfp3_i2c_scl]
set_property -dict {LOC BA24 IOSTANDARD LVCMOS18 } [get_ports qsfp3_i2c_sda]
